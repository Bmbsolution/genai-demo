"""Password hashing (argon2id) and JWT creation/verification (RS256).

Pure functions: keys and TTLs are passed in, so this module has no dependency on
settings, Redis, or the database and is trivially unit-testable. The settings-
aware wrapper that reads the configured keypair lives in the auth service.
"""
